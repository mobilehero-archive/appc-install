...
function download(force, wantVersion, tmpfile, stream, location, callback, nobanner) {
	!nobanner && !wantVersion && util.waitMessage('Finding latest version ...');
	!nobanner && wantVersion && util.waitMessage('Finding version '+wantVersion+' ...');
	...
	util.request(location, function(err,res,req){
		...
		if (res.statusCode===301 || res.statusCode===302) {
			...
			!nobanner && !wantVersion && util.okMessage(chalk.green(version));
			!nobanner && wantVersion && util.okMessage(chalk.green('✓'));
